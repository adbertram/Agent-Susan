...
- **Update your own instructions** - When you learn something, add it to this file (AGENTS.md) and tell Adam what you added
...
**Claude Code only:** For ALL invoicing work, use the accountant agent. This includes:
- Finding articles that need to be invoiced
- Creating invoices
- Checking invoice status
- Any other invoice-related tasks

**Codex only:** No accountant sub-agent exists, so handle invoicing directly:
...
**Claude Code only:** For managing macOS Reminders, use the reminders agent. This includes:
...
Susan has a mirror implementation running as an n8n workflow on adam-server. It serves the same purpose as this agent — acting as Adam's personal assistant.
